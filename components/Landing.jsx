    ...
    return (
        <div className='text-[#A1ECFB] container m-auto'>
            ...
            <div style={{ height: 'calc(100vh - 120px)' }} className=" overflow-y-auto overflow-x-auto">
                <div className="md:w-[700px] w-[96%] m-auto border border-[#029DBB] p-2 md:my-5 my-3  text-xl relative xyz-in">
                    <CornerBorder xyz="fade small stagger ease-out-back"/>
                    <h2 className='font-[electrolize] text-3xl font-semibold capitalize xyz-in' xyz="fade up flip-down">PROTECT YOUR PRIVACY</h2>
                    <div className=" w-[98%] m-auto border-l-4 ml-3 md:mt-5 mt-3 px-2 border-[#26DAFD] font-[titlium] xyz-in" xyz="fade up flip-up">
                    ...
                    <div className="container m-auto mt-3 md:mt-5 font-[titlium] text-[#26DAFD] xyz-in" xyz="fade up flip-up">
                    ...
                    <div className="container flex flex-wrap  m-auto mt-3 md:mt-5 font-[titlium]" xyz="fade small stagger ease-out-back">
                        <img src="https://img.shields.io/badge/No Cost-Free-blue" className='mx-1 xyz-nested' alt="users" />
                        <img src="https://img.shields.io/badge/100+-Users-important" className='mx-1 xyz-nested' alt="users" />
                        <img src="https://img.shields.io/badge/100+-Email Sent-029DBB" className='mx-1 xyz-nested' alt="users" />
                        <img src="https://img.shields.io/badge/10 Address-Available-brightgreen" className='mx-1 xyz-nested' alt="users" />
                    </div>
                    <Link href="/sendemail"><h2 className='font-[electrolize] text-3xl font-semibold capitalize mt-5 hover:text-white'>GET STARTED</h2></Link>
                    <div className="container m-auto mt-2 font-[titlium] text-[#26DAFD]" xyz="fade down stagger ease-out-back flip-up">
